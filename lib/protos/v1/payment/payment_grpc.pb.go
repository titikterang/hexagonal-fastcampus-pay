...
const (
	PaymentService_HealthCheck_FullMethodName            = "/fastcampus.payment.v1.PaymentService/HealthCheck"
...
func (c *paymentServiceClient) HealthCheck(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
...
func (UnimplementedPaymentServiceServer) HealthCheck(context.Context, *emptypb.Empty) (*HealthResponse, error) {
...
func _PaymentService_HealthCheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).HealthCheck(ctx, req.(*emptypb.Empty))
	}
